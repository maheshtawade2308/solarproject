  ...
  return (
    <div className="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
      <div className="owl-carousel header-carousel position-relative">
        {/* First Carousel Item */}
        <div className="owl-carousel-item position-relative" data-dot={<img src='img/carousel-1.jpg' alt='' />}>
        ...
        <div className="owl-carousel-item position-relative" data-dot={<img src='img/carousel-2.jpg' alt='' />}>
        ...
        {/* Third Carousel Item */}
        <div className="owl-carousel-item position-relative" data-dot={<img src='img/carousel-3.jpg' alt='' />}>
